                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                ...
                                fit: BoxFit.cover,
                                image: AssetImage(movie.backdrop as String))),
              ...
              Padding(
                ...
                child: Row(children: [
                  ...List.generate(movie.cast!.length, (index) {
                    var first_name =
                        movie.cast![index]["orginalName"].split(" ")[0];
                    var Last_name =
                        movie.cast![index]["orginalName"].split(" ")[1];
                    print(first_name);
                    print(Last_name);
                    return ActorCard(
                      first_name,
...
class ActorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          CircleAvatar(radius: 35, child: Image.asset(this.path)),
          SizedBox(
            height: 10,
          ),
